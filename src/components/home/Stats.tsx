...
const stats: StatItem[] = [
  { value: '17+', label: 'Websites launched', subtext: 'Helping brands make their mark online.' },
  { value: '1.1M+', label: 'Users reached', subtext: 'Our designs engage millions globally.' },
  { value: '54%', label: 'Client satisfaction rate', subtext: 'We build long-term partnerships.' },
  { value: '6+', label: 'Years of expertise', subtext: 'Decades of experience in delivering impact.' },
];
...
const Stats: React.FC = () => {
  return (
    <section 
      ...
      className="bg-white text-brand-black py-20 md:py-32 scroll-mt-28 overflow-hidden"
    >
      <div className="container mx-auto px-6">
        <header className="flex flex-col md:flex-row gap-12 mb-20 items-start">
          ...
          <Reveal width="fit-content" delay={0}>
            ...
            >
                <TrendingUp className="text-brand-red" size={24} aria-hidden="true" />
            </div>
          </Reveal>
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border-t border-gray-200 pt-12">
          {stats.map((stat, index) => (
            <Reveal key={index} delay={index * 100} width="100%">
                ...
                <dd className="text-5xl md:text-6xl font-bold text-brand-black group-hover:text-brand-red transition-colors duration-300 tabular-nums tracking-tight">
